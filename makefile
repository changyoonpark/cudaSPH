...
particleSolver.o: particleSolver.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

globalDefs.o: globalDefs.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
...
particles: main.o particleSystem.o particleSolver.o globalDefs.o particleSystem_cuda.o displayFunctions.o
...
clean:
	rm -f particles main.o particleSystem.o particleSolver.o globalDefs.o particleSystem_cuda.o displayFunctions.o
	rm -rf ../$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/particles
